...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('xml2js'), require('date-fns'), require('aes-js'), require('jsbarcode'), require('qrcode')) :
    typeof define === 'function' && define.amd ? define(['xml2js', 'date-fns', 'aes-js', 'jsbarcode', 'qrcode'], factory) :
    (global = global || self, global.IReceipt = factory(global.xml2js, global.datefns, global.aesjs, global.JsBarcode, global.QRCode));
}(this, function (xml2js, dateFns, aesjs, JsBarcode, QRCode) { 'use strict';
    ...
    function () {
      function ReceiptInfo(number, date, seller, buyer) {
        ...
        babelHelpers.classCallCheck(this, ReceiptInfo);
        this.number = number;
        this.date = date;
        this.seller = seller;
        this.buyer = buyer;
      ...
      babelHelpers.createClass(ReceiptInfo, [{
        key: "toXMLObject",
        value: function toXMLObject() {
          var xmlObject = {
            InvoiceNumber: this.number,
            InvoiceDate: dateFns.format(this.date, 'yyyyMMdd'),
            InvoiceTime: dateFns.format(this.date, 'hh:mm:ss'),
            Seller: {
    ...
    function () {
      ...
      babelHelpers.createClass(Amount, [{
        key: "toXMLObject",
        value: function toXMLObject() {
          return {
    ...
    var defaultInvoiceAttr = {
      ...
      'xsi:schemaLocation': 'urn:GEINV:eInvoiceMessage:C0401:3.1 C0401.xsd'
        ...
        renderQRcode = function renderQRcode(text) {
    ...
    function () {
      function Receipt(info, items) {
        babelHelpers.classCallCheck(this, Receipt);
      ...
      babelHelpers.createClass(Receipt, [{
        key: "toXML",
        // Methods
        ...
        value: function render(AESKey) {
          ...
          return Promise.all(promises).then(function (_ref) {
            ...
            var buyerIdHtmlString = _this.info.buyer.id ? "<div class=\"buyer-identifier\">\n                        \u8CB7\u65B9".concat(_this.info.buyer.id, "\n                      </div>") : '';
            return "".concat(template, "\n                    <div class=\"receipt\">\n                        <div class=\"einvoice-name\">\n                            ").concat(_this.info.seller.name, "\n                        </div>\n                        <div class=\"receipt-title\">\u96FB\u5B50\u767C\u7968\u8B49\u660E\u806F</div>\n                        <div class=\"receipt-year-month\">\n                            ").concat(_this.chineseYear, "\u5E74\n                            ").concat(_this.winningMonths[0], "-").concat(_this.winningMonths[1], "\u6708 \n                        </div>\n                        <div class=\"receipt-invoice-number\">\n                            ").concat(_this.info.number, "\n                        </div>\n                        <div class=\"receipt-issue-time\">\n                            ").concat(dateFns.format(_this.info.date, 'yyyy-MM-dd hh:mm:ss'), "\n                        </div>\n                        <div class=\"receipt-random-number\">\n                            \u96A8\u6A5F\u78BC ").concat(_this.info.randomNumber, "\n                        </div>\n                        <div class=\"receipt-amount\">\n                            \u7E3D\u8A08 ").concat(intlNumberFormat.format(_this.amount.totalAmount), "\n                        </div>\n                        <div class=\"einvoice-identifier\">\n                            \u8CE3\u65B9").concat(_this.info.seller.id, "\n                        </div>\n                        ").concat(buyerIdHtmlString, "\n                        <div class=\"einvoice-barcode\">").concat(barCode, "</div>\n                        <div class=\"einvoice-qrcode-left\">").concat(leftQRCode, "</div>\n                        <div class=\"einvoice-qrcode-right\">").concat(rightQRCode, "</div>\n                        <div class=\"einvoice-remark\">\u9000\u8CA8\u6191\u96FB\u5B50\u767C\u7968\u8B49\u660E\u806F\u6B63\u672C\u8FA6\u7406</div>\n                    </div>");
          });
        }
      }, {
        key: "renderBarCode",
